...
> 🎯 对应简历项目：**Story 1 — VoC XGBoost 预测转人工** | **Story 2 — 调度 XGBoost 残差修正**
...
??? note "Q3: 特征重要性怎么解读？"
    → [查看降维打击回答：难题 3](17_interview_prep.md#31-p7-难题回答策略-折叠闪卡)
...
??? warning "Q5: Feature Importance Top 3 是什么？怎么解释？"
    **来源**：Gemini 模拟面试 Q3
    **答法**：(1) 用户情感极性分 (2) 对话轮次 (3) 未解决意图数。情绪激动+追问多=转人工概率最高

??? warning "Q6: VoC 挖掘出 Top 30 痛点，怎么确定优先级？模型有偏差吗？"
    **来源**：DeepSeek 模拟面试 Q1
